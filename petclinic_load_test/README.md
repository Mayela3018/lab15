...
#### - mvn clean install -P dev  --> aplication-dev.properties
#### - mvn clean install -P test --> aplication-test.properties
#### - mvn clean install -P prod --> aplication-prod.properties
